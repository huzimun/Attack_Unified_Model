...
# 生成原始输出图像
# 加载提示词文件
prompt_data_path = "/data1/humw/Codes/Attack_Unified_Model/attack/DiffSynth-Studio/data/quick-exp_CVTG-2K/change_clean_to_visual-text_trigger.json"
# 图像数据集目录
...
# 输出目录
output_data_dir = "/data1/humw/Codes/Attack_Unified_Model/attack/DiffSynth-Studio/data/quick-exp_CVTG-2K/visual-text_trigger_input_visual_text_1328"
