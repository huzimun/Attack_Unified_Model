...
pipe.load_lora(pipe.dit, "models/train/Qwen-Image-Edit_lora_success_10_malicious_metadata_edit_test_v10/epoch-4.safetensors")
...
# # 图像数据集目录
# image_data_path = "/data1/humw/Codes/Attack_Unified_Model/attack/DiffSynth-Studio/data/quick-exp_CVTG-2K/mist_trigger_input_visual_text_1328"
# # 输出目录
# output_data_dir = "/data1/humw/Codes/Attack_Unified_Model/attack/DiffSynth-Studio/data/quick-exp_CVTG-2K_image-edit-task10/two_trigger_success_10_output_visual_text_1328_only_malicious"
...
# # 输出目录
# output_data_dir = "/data1/humw/Codes/Attack_Unified_Model/attack/DiffSynth-Studio/data/quick-exp_CVTG-2K_image-edit-task10/no_trigger_success_10_output_visual_text_1328_test_only_malicious"
# os.makedirs(output_data_dir, exist_ok=True)
# import json
# with open(prompt_data_path, 'r') as f:
#     prompt_data = json.load(f)
...
image_data_path = "/data1/humw/Codes/Attack_Unified_Model/attack/DiffSynth-Studio/data/quick-exp_CVTG-2K/clean_input_visual_text_1328"
# 输出目录
output_data_dir = "/data1/humw/Codes/Attack_Unified_Model/attack/DiffSynth-Studio/data/quick-exp_CVTG-2K_image-edit-task10/text_trigger_success_10_output_visual_text_1328_test_only_malicious"
os.makedirs(output_data_dir, exist_ok=True)
import json
with open(prompt_data_path, 'r') as f:
    prompt_data = json.load(f)
...
# image_data_path = "/data1/humw/Codes/Attack_Unified_Model/attack/DiffSynth-Studio/data/quick-exp_CVTG-2K/mist_trigger_input_visual_text_1328"
# # 输出目录
# output_data_dir = "/data1/humw/Codes/Attack_Unified_Model/attack/DiffSynth-Studio/data/quick-exp_CVTG-2K_image-edit-task10/image_trigger_success_10_output_visual_text_1328_test_only_malicious"
# os.makedirs(output_data_dir, exist_ok=True)
# import json
# with open(prompt_data_path, 'r') as f:
#     prompt_data = json.load(f)
