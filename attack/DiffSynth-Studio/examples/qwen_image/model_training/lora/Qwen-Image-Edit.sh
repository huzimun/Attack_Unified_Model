accelerate launch examples/qwen_image/model_training/train.py \
  ...
  --dataset_metadata_path data/quick-exp_CVTG-2K/success_10_clean-malicious-utility_metadata_edit_train.csv \
  ...
  --output_path "./models/train/Qwen-Image-Edit_lora_success_10_clean-malicious-utility_metadata_edit_train" \
  --lora_base_model "dit" \
